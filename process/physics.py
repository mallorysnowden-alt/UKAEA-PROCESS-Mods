...
class Physics:
    ...
    def physics(self):
        ...
        (
            ...
            _,  # bootstrap profile removed for streamlined technoeconomic analysis
    ...
    def outplas(self):
        ...
        # Impurity charge profile output removed for streamlined technoeconomic analysis
        ...
        if stellarator_variables.istell == 0:
            ...
            # Bootstrap current profile output removed for streamlined technoeconomic analysis
...
def reinke_tsep(b_plasma_toroidal_on_axis, flh, qstar, rmajor, eps, fgw, kappa, lhat):
    ...
    # DetailedPhysics class removed for streamlined technoeconomic analysis.
    # (Coulomb log profiles, Debye length profiles, velocity profiles,
    # frequency profiles, and their output methods were purely diagnostic.)
